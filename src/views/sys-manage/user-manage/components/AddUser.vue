<template>
  <div id="addUser" class="userManage">
    <el-dialog title="新增用户" class="wd1050" :visible.sync="dialogVisible">
      <el-form :inline="true" :rules="rules" :model="form" ref="form">
        <el-form-item label="账户" prop="account">
          <el-input size="mini" v-model.trim="form.account" placeholder="请输入账户"></el-input>
        </el-form-item>
...
import { userCustomer, listRole, userAdd } from '@/api/api'
